      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Unable to Logout,Please try again!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmluZWV0am9jIiwiYSI6ImNrcW1sMnllOTEyM3kyeHBoZ3MwcGRuNHkifQ.VtsLFHQWD_9oFPpqnWGRVg';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Updated Sucessfully"));
            _context.next = 11;
            break;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JBLnmSDiXrpvXLOm2jF0mbezhR7xidL2kAwcBqzeAALhYiiUpk57TcTByPjC8CixYjN7Q2v7htW7GfPtDkatgT400oLrHkD3v');
            _context.prev = 1;
            _context.next = 4;
...
var mapBox = document.getElementById('map'); // const mapBox = document.querySelector('.section-map');
...
var bookTourBtn = document.getElementById('book-tour'); // document.getElementById
...
if (updateData) {
  updateData.addEventListener('submit', function (e) {
    ...
    var formData = new FormData(); //using FromData because we need to uplaod file as well
    ...
    (0, _settings.updateSettings)(formData, 'data');
  });
}
...
if (loginForm) {
  document.querySelector('.form').addEventListener('submit', function (el) {
    ...
    var password = document.getElementById('password').value; //   console.log('hello');

    (0, _login.login)(email, password);
  });
}

if (bookTourBtn) bookTourBtn.addEventListener('click', /*#__PURE__*/function () {
...
},{"./login":"login.js","./mapbox":"mapbox.js","./settings":"settings.js","./stripe":"stripe.js"}]},{},["index.js"], null)
